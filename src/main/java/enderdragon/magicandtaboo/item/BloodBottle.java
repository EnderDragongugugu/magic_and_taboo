...
public class BloodBottle extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltips, TooltipFlag flag) {
        ...
        tooltips.add(Component.translatable("tooltip.magicandtaboo.blood_bottle_pureness", storage.getFormattedPureness()));
    }

    @Override
    public @NotNull Component getName(ItemStack stack) {
        var source = stack.getCapability(PURENESS).orElse(IPurenessStorage.EMPTY).getSource();
        return source == null ? super.getName(stack) : Component.translatable("item.magicandtaboo.blood_bottle.has_entity", source.getDescription());
    }
