...
public class MATBlockEntityTypes {
    ...
    public static final RegistryObject<BlockEntityType<FederationWorkstationBlockEntity>> FEDERATION_WORKSTATION = REGISTRY.register("federation_workstation", () ->
            BlockEntityType.Builder.of(FederationWorkstationBlockEntity::new, MATBlocks.FEDERATION_WORKSTATION.get()).build(null)
    );
}
