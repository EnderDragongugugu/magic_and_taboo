...
import enderdragon.magic_and_taboo.item.AlchemyMaterialItem;
...
public class MATItemGroups {
    ...
    public static final ItemGroup POTION = ItemGroup.of(
            AlchemyElementItem::fillDisplayStacks,
            AlchemyMaterialItem::fillDisplayStacks
    );
