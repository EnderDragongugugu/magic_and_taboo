...
public class PurenessStorage implements IPurenessStorage, ICapabilityProvider, INBTSerializable<CompoundTag>, Function<IPurenessStorage, ItemStack> {
    private static final Reference2ObjectOpenHashMap<Item, Function<IPurenessStorage, ItemStack>> CONTAINERS = new Reference2ObjectOpenHashMap<>();

    public static boolean registerContainer(Item container, Function<IPurenessStorage, ItemStack> filler) {
    ...
    public PurenessStorage(int max, Item container, boolean virtual) {
        this.max = max;
    ...
    @Override
    public ItemStack apply(IPurenessStorage storage) {
        return ItemStack.EMPTY;
    }
