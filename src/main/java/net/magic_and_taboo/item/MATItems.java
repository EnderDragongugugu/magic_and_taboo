...
public class MATItems {
    public static final Item COPPER_COIN = basicItem(MagicAndTabooMod.MAGIC,64);
    public static final Item SILVER_COIN = basicItem(MagicAndTabooMod.MAGIC,64);
    public static final Item GOLD_COIN = basicItem(MagicAndTabooMod.MAGIC,64);
    public static final Item CALENDAR = TimeItem(MagicAndTabooMod.MAGIC);
    public static final Item CALENDAR_WATCHES = TimeItem(MagicAndTabooMod.MAGIC);
    public static final Item COPPER_WATCHES = TimeItem(MagicAndTabooMod.MAGIC);
    public static final Item STAR_BOOK = basicItem(MagicAndTabooMod.MAGIC,1);
    public static final Item STAR_BOOK_MAX = basicItem(MagicAndTabooMod.MAGIC,1);
    ...
    public static Item StarMapItem(String str){
        return new StarMapItems(new Item.Settings().group(MagicAndTabooMod.MOONLIGHT).maxCount(16),str);
    }
    public static Item TimeItem(ItemGroup group){
        return new TimeItem(new Item.Settings().group(MagicAndTabooMod.MOONLIGHT).maxCount(1));
    }
}
